...
|                                   | In the current tabulation, the    |
|                                   | MASATI comparison leaves the DINO |
|                                   | Recall entry blank as well,       |
|                                   | whereas the HRSC2016-MS           |
|                                   | comparison reports the available  |
|                                   | recall-related quantity as AR@100 |
|                                   | rather than conventional          |
|                                   | fixed-threshold Recall.           |
|                                   | Accordingly, the starred value    |
|                                   | 0.731\* on HRSC2016-MS should be  |
|                                   | interpreted only as a             |
|                                   | recall-related reference from the |
|                                   | reproduced DINO COCO-style        |
|                                   | evaluation output, rather than as |
|                                   | a directly comparable             |
|                                   | conventional Recall value under   |
|                                   | the same confidence-threshold     |
|                                   | definition used for the other     |
|                                   | detectors.                        |
|                                   |                                   |
|                                   | Table2                            |
|                                   |                                   |
...
|                                   | refinement module substantially   |
|                                   | improves performance. The fixed τ |
|                                   | / η variant achieves 0.835        |
|                                   | Precision, 0.728 Recall, 0.825    |
|                                   | mAP@0.5, and 0.549 mAP@0.5:0.95,  |
|                                   | while the complete YOLOv12 + DMMA |
|                                   | + ECA model reaches 0.838         |
|                                   | Precision, 0.733 Recall, 0.829    |
|                                   | mAP@0.5, and 0.545 mAP@0.5:0.95.  |
|                                   | These two configurations are      |
|                                   | therefore very close under the    |
|                                   | current setting: the full model   |
|                                   | is slightly better in Precision,  |
|                                   | Recall, and mAP@0.5, whereas the  |
|                                   | fixed-parameter variant is        |
|                                   | slightly better in mAP@0.5:0.95.  |
|                                   | This suggests that making τ and η |
|                                   | learnable is helpful for overall  |
|                                   | optimization, but its benefit is  |
|                                   | not uniformly dominant across all |
|                                   | metrics. More importantly, both   |
|                                   | variants remain clearly stronger  |
|                                   | than the DMMA-only model,         |
|                                   | indicating that the main observed |
|                                   | gain beyond the baseline still    |
|                                   | comes from the combination of     |
|                                   | difference-aware attention and    |
|                                   | channel refinement.               |
|                                   |                                   |
