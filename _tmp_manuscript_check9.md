...
|                                   | trade-off between detection       |
|                                   | accuracy and inference speed      |
|                                   | under the current evaluation      |
|                                   | setting, with only a limited FPS  |
|                                   | reduction from 76 to 70.          |
|                                   |                                   |
...
|                                   | starred DINO entry on HRSC2016-MS |
|                                   | corresponds to AR@100 under the   |
|                                   | COCO protocol and is therefore    |
...
|                                   | factors provide small             |
|                                   | metric-dependent effects rather   |
|                                   | than uniform gains across all     |
|                                   | evaluation metrics. Overall, the  |
