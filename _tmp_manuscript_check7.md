...
|                                   | protocol.                         |
|                                   |                                   |
|                                   | For methods whose evaluation      |
|                                   | outputs do not provide            |
|                                   | conventional Precision or         |
|                                   | fixed-threshold Recall, only the  |
|                                   | available metrics are reported    |
|                                   | and explicitly marked when        |
|                                   | necessary. Since the reproduced   |
|                                   | DINO evaluation output under the  |
|                                   | COCO protocol does not provide    |
|                                   | traditional Precision values      |
|                                   | under a fixed confidence          |
|                                   | threshold, its Precision entries  |
|                                   | are left blank in Tables 3 and 5. |
|                                   | The available recall-related      |
|                                   | quantity in DINO follows the COCO |
|                                   | evaluation protocol and is        |
|                                   | reported as AR@100 rather than    |
|                                   | the conventional Recall under a   |
|                                   | fixed confidence threshold. For   |
|                                   | completeness, the AR@100 values   |
|                                   | are listed in the Recall column   |
|                                   | with an asterisk, namely 0.469\*  |
|                                   | on MASATI and 0.731\* on          |
|                                   | HRSC2016-MS, corresponding to     |
|                                   | 46.9% and 73.1%, respectively.    |
|                                   | Here, the asterisk indicates that |
|                                   | these entries should be           |
|                                   | interpreted only as               |
|                                   | recall-related reference values   |
|                                   | from the reproduced DINO          |
|                                   | COCO-style evaluation output,     |
|                                   | rather than as directly           |
