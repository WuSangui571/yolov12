...
|                                   | Meanwhile, the ECA refinement     |
|                                   | module recalibrates informative   |
|                                   | channels while preserving         |
|                                   | practical inference efficiency.   |
|                                   | Experiments on MASATI and         |
|                                   | HRSC2016-MS demonstrate the       |
...
|                                   | activation magnitude and          |
|                                   | alleviates over-sensitivity to    |
|                                   | local intensity or illumination   |
|                                   | variation, so the gate focuses    |
|                                   | more on relative structural       |
|                                   | inconsistency than on raw         |
|                                   | response scale.                   |
|                                   |                                   |
...
|                                   | In this way, interactions         |
|                                   | associated with larger structural |
|                                   | inconsistency are attenuated      |
|                                   | without introducing a separate    |
|                                   | additive bias term, while the     |
|                                   | original attention formulation    |
|                                   | and relative comparison within    |
|                                   | the same window are preserved. In |
|                                   | practice, this design is used to  |
|                                   | suppress misleading token         |
|                                   | interactions that would otherwise |
|                                   | compete strongly during attention |
|                                   | normalization, rather than to     |
|                                   | redefine attention solely by the  |
|                                   | gate itself. The learnable        |
|                                   | temperature parameterτand mask    |
|                                   | scaling factor η further allow    |
|                                   | the suppression strength to adapt |
|                                   | across feature levels and         |
|                                   | datasets, although a more         |
...
|                                   | Figure2                           |
|                                   |                                   |
|                                   | ![](media/image2.png){width="5.92 |
|                                   | 3611111111111in"                  |
|                                   | height="3.0694444444444446in"}To  |
...
|                                   | horizontal detectors. In the      |
|                                   | HRSC2016-MS experiments, the      |
...
|                                   | subsets with a ratio of 8:1:1,    |
|                                   | corresponding to 80%, 10%, and    |
|                                   | 10% of the images, respectively.  |
|                                   | The split was fixed once for this |
|                                   | study and then consistently       |
|                                   | reused for all compared methods   |
|                                   | to ensure fair evaluation under   |
...
|                                   | methods were organized under the  |
|                                   | same train/validation/test split  |
|                                   | and the same evaluation protocol  |
|                                   | in this study. For the            |
|                                   | YOLOv12-series ablations, the     |
|                                   | optimizer, training schedule,     |
|                                   | input resolution, and             |
|                                   | augmentation settings were kept   |
|                                   | identical. For external           |
|                                   | baselines, the corresponding      |
|                                   | official implementations,         |
|                                   | released logs, or reported        |
|                                   | results were followed according   |
|                                   | to availability, and all results  |
|                                   | were re-tabulated under the same  |
|                                   | dataset partition and metric      |
|                                   | definitions used in this paper.   |
|                                   | Therefore, the comparison focuses |
|                                   | on reproducible detector          |
|                                   | performance under a unified data  |
|                                   | split and evaluation protocol,    |
|                                   | rather than on forcing            |
|                                   | architecture-specific methods to  |
|                                   | share exactly the same            |
|                                   | optimization details.             |
|                                   |                                   |
|                                   | For methods whose released logs   |
|                                   | do not provide conventional       |
|                                   | Precision or fixed-threshold      |
|                                   | Recall, only the officially       |
|                                   | available metrics are reported    |
|                                   | and explicitly marked when        |
|                                   | necessary. Since the released     |
...
|                                   | AR@100 values are listed in the   |
|                                   | Recall column with an asterisk,   |
|                                   | namely 0.469\* on MASATI and      |
|                                   | 0.731\* on HRSC2016-MS,           |
|                                   | corresponding to 46.9% and 73.1%, |
|                                   | respectively. Here, the asterisk  |
|                                   | indicates that these entries      |
|                                   | should be interpreted only as     |
|                                   | recall-related reference values   |
|                                   | from the official DINO evaluation |
|                                   | output, rather than as directly   |
|                                   | comparable conventional Recall    |
...
|                                   | comparison or ranking against the |
...
|                                   | best overall results on MASATI    |
...
|                                   | ***Table3***                      |
|                                   |                                   |
|                                   | Table 3 reports the ablation and  |
...
|                                   | from 0.736 to 0.745, Recall from  |
|                                   | 0.649 to 0.653, mAP@0.5 from      |
|                                   | 0.628 to 0.671, and mAP@0.5:0.95  |
|                                   | from 0.222 to 0.319. These gains  |
...
|                                   | configuration is clearly stronger |
|                                   | than the baseline and the         |
|                                   | ECA-only model, it remains        |
|                                   | notably inferior to the complete  |
|                                   | DMMA design, showing that the     |
|                                   | major gain does not come merely   |
|                                   | from adding an extra branch or    |
|                                   | additional parameters, but from   |
...
|                                   | model, introducing the ECA        |
|                                   | refinement module and keeping the |
|                                   | learnable temperature and mask    |
|                                   | scaling factors further improves  |
|                                   | performance. The fixedτ /ηvariant |
|                                   | achieves 0.835 Precision, 0.728   |
|                                   | Recall, 0.833 mAP@0.5, and 0.549  |
|                                   | mAP@0.5:0.95, which is already    |
|                                   | very close to the final model.    |
|                                   | The complete YOLOv12 + DMMA + ECA |
|                                   | model still achieves the best     |
|                                   | overall performance, with 0.838   |
|                                   | Precision, 0.733 Recall, 0.839    |
|                                   | mAP@0.5, and 0.555 mAP@0.5:0.95.  |
|                                   | This indicates that the learnable |
|                                   | temperature and mask scaling      |
|                                   | factors provide a consistent but  |
|                                   | secondary gain, whereas the       |
|                                   | dominant contribution still comes |
|                                   | from the difference-aware         |
|                                   | attention design itself.          |
|                                   |                                   |
...
|                                   | recall-related reference value    |
|                                   | rather than used for direct       |
|                                   | comparison or ranking against     |
|                                   | conventional Recall.              |
|                                   |                                   |
...
|                                   | comparable metrics on HRSC2016-MS |
|                                   | among YOLOv8, RT-DETR, LiM-YOLO,  |
|                                   | FBVF-YOLO, and the proposed model |
|                                   | itself. This result indicates     |
|                                   | that the proposed DMMA + ECA      |
|                                   | design improves both target       |
|                                   | discovery and stricter            |
|                                   | localization quality on this      |
|                                   | dataset, rather than only         |
...
|                                   | mAP@0.5:0.95; using fixed τandη   |
...
|                                   | and that learnable τ andη provide |
|                                   | additional but smaller gains.     |
|                                   |                                   |
...
|                                   | repeated runs. After introducing  |
...
|                                   | same time, the full model         |
|                                   | achieves the strongest accuracy   |
|                                   | with only a limited FPS reduction |
|                                   | from 76 to 70, indicating that    |
...
|                                   | visible change is the suppression |
...
|                                   | the ECA refinement module, true   |
|                                   | ship responses become more        |
|                                   | concentrated and some residual    |
|                                   | false alarms are further reduced, |
|                                   | especially in scenes with         |
|                                   | repetitive sea-surface textures.  |
|                                   | From a qualitative perspective,   |
|                                   | the main gains therefore appear   |
|                                   | to come from two aspects: fewer   |
|                                   | false alarms on cluttered         |
|                                   | maritime backgrounds and better   |
|                                   | recovery of weak true positives   |
|                                   | for tiny ships.                   |
|                                   |                                   |
...
|                                   | Attention and an ECA refinement   |
|                                   | module. The proposed method aims  |
...
|                                   | proposed method achieves the best |
|                                   | values on the four directly       |
|                                   | comparable metrics among YOLOv8,  |
|                                   | RT-DETR, LiM-YOLO, FBVF-YOLO, and |
|                                   | the proposed model itself, namely |
|                                   | Precision, Recall, mAP@0.5, and   |
|                                   | mAP@0.5:0.95. The AR@100 values   |
|                                   | reported for DINO are marked with |
|                                   | \* and are not directly compared  |
|                                   | with conventional Recall. These   |
|                                   | results suggest that the proposed |
|                                   | design is effective for target    |
|                                   | discovery and overall detection   |
...
|                                   | comparison and mechanism-ablation |
|                                   | results indicate that the         |
|                                   | proposed model achieves the best  |
|                                   | overall results on MASATI and,    |
|                                   | under the updated HRSC2016-MS     |
|                                   | evaluation setting, also achieves |
|                                   | the best values on the four       |
|                                   | directly comparable metrics among |
|                                   | the main compared methods. The    |
|                                   | expanded ablation study further   |
|                                   | confirms that the                 |
|                                   | difference-aware gate is the      |
|                                   | dominant source of improvement,   |
|                                   | that deploying DMMA in the neck   |
|                                   | is more effective than using it   |
|                                   | only in the backbone, and that    |
|                                   | the learnable temperature and     |
|                                   | mask scaling factors provide      |
|                                   | additional but smaller gains.     |
|                                   | Therefore, the present work       |
|                                   | should be viewed as a detection   |
|                                   | framework that improves           |
|                                   | target-background discrimination  |
|                                   | and target discovery for          |
|                                   | small-ship detection, while still |
|                                   | leaving room for further          |
|                                   | improvement in more challenging   |
|                                   | fine-grained boundary cases.      |
|                                   |                                   |
|                                   | In future work, we will further i |
|                                   | nvestigate more detailed sensitiv |
|                                   | ity analyses of window size and h |
|                                   | ead configuration, richer respons |
|                                   | e visualization for the differenc |
|                                   | e-aware suppression mechanism, an |
|                                   | d stronger boundary-aware regress |
|                                   | ion constraints together with loc |
|                                   | alization-enhanced detection head |
|                                   | s to further improve precise box  |
|                                   | alignment while preserving the cu |
|                                   | rrent gains in small-ship discove |
|                                   | ry. {#in-future-work-we-will-furt |
|                                   | her-investigate-more-detailed-sen |
|                                   | sitivity-analyses-of-window-size- |
|                                   | and-head-configuration-richer-res |
|                                   | ponse-visualization-for-the-diffe |
|                                   | rence-aware-suppression-mechanism |
|                                   | -and-stronger-boundary-aware-regr |
|                                   | ession-constraints-together-with- |
|                                   | localization-enhanced-detection-h |
|                                   | eads-to-further-improve-precise-b |
|                                   | ox-alignment-while-preserving-the |
|                                   | -current-gains-in-small-ship-disc |
|                                   | overy. .IOPP-H1}                  |
|                                   | ================================= |
|                                   | ================================= |
|                                   | ================================= |
