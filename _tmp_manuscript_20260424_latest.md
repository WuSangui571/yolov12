...
|                                   | more directly to                  |
|                                   | target-background discrimination, |
|                                   | while combining backbone and neck |
|                                   | yields the strongest overall      |
|                                   | representation.                   |
|                                   |                                   |
...
|                                   | improves performance. The fixed   |
|                                   | tau / eta variant achieves 0.835  |
...
|                                   | fixed tau / eta variant also      |
|                                   | keeps 62.7M parameters and 215.4G |
...
|                                   | design provides a favorable       |
|                                   | accuracy-cost trade-off for       |
|                                   | high-performance remote sensing   |
|                                   | ship detection, especially in     |
|                                   | scenarios where robust            |
|                                   | discrimination under cluttered    |
|                                   | maritime backgrounds is more      |
|                                   | critical than extreme lightweight |
|                                   | deployment.                       |
|                                   |                                   |
|                                   | table5                            |
|                                   |                                   |
...
|                                   | achieves the strongest directly   |
...
|                                   | model achieves the strongest      |
|                                   | overall performance on MASATI     |
|                                   | and, under the updated            |
|                                   | HRSC2016-MS evaluation setting,   |
|                                   | also achieves the best values on  |
|                                   | the four directly comparable      |
|                                   | metrics among the main compared   |
|                                   | methods. The expanded ablation    |
|                                   | study further confirms that the   |
...
|                                   | combines target-background        |
|                                   | discrimination, robust target     |
|                                   | discovery, and strong overall     |
|                                   | localization quality, while still |
...
|                                   | constraints for more precise box  |
