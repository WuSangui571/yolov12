...
|                                   | method achieves the best mAP@0.5  |
|                                   | on both datasets and the best     |
...
|                                   | the same data partition. Dataset  |
|                                   | statistics and split details are  |
|                                   | summarized in Table X, including  |
|                                   | image numbers,                    |
|                                   | train/validation/test counts,     |
|                                   | class setting, annotation         |
|                                   | representation, and the split     |
|                                   | seed used in this study.          |
|                                   |                                   |
|                                   | Table X. Dataset statistics and   |
|                                   | split details used in this study. |
|                                   |                                   |
|                                   | \| Dataset \| Images \| Train \|  |
|                                   | Val \| Test \| Classes \|         |
|                                   | Annotation \| Split seed \|       |
|                                   |                                   |
|                                   | \|\-\-\-\-\-\-\-\-\-\-\-\--\|\-\- |
|                                   | \-\-\-\-\--\|\-\-\-\-\-\--\|\-\-\ |
|                                   | -\--\|\-\-\-\-\--\|\-\-\-\-\-\-\- |
...
|                                   |                                   |
|                                   | To ensure as fair a comparison as |
|                                   | possible, all methods were        |
|                                   | organized under the same          |
|                                   | train/validation/test split and   |
|                                   | the same evaluation protocol in   |
|                                   | this study. For the               |
...
|                                   | baselines, reproduced results and |
|                                   | officially available reported     |
|                                   | results were both used according  |
|                                   | to availability. Reproduced       |
|                                   | baselines were trained and        |
|                                   | evaluated under the present       |
|                                   | setting, whereas reported         |
|                                   | baselines were re-tabulated under |
|                                   | the same dataset partition and    |
|                                   | metric definitions used in this   |
|                                   | paper whenever the corresponding  |
|                                   | outputs were available.           |
|                                   | Therefore, the comparison should  |
|                                   | be interpreted as a unified       |
|                                   | evaluation under the same data    |
|                                   | split and metric convention,      |
|                                   | while still respecting the        |
|                                   | practical availability of public  |
|                                   | implementations and released      |
|                                   | results for different detector    |
|                                   | families.                         |
|                                   |                                   |
...
|                                   | performance. The fixedτ/η variant |
...
|                                   | reported results should not be    |
|                                   | directly compared with            |
|                                   | oriented-bounding-box results in  |
|                                   | previous HRSC2016 literature. As  |
|                                   | shown in Table 4, the proposed    |
|                                   | YOLOv12 + DMMA + ECA model        |
|                                   | achieves a Precision of 0.837,    |
|                                   | Recall of 0.728, mAP@0.5 of       |
|                                   | 0.824, and mAP@0.5:0.95 of 0.589. |
|                                   | Compared with YOLOv8, the         |
...
|                                   | mAP-based evaluation. The DINO    |
|                                   | Recall value marked with \* is    |
|                                   | AR@100 under the COCO protocol    |
|                                   | and is therefore reported only as |
|                                   | a recall-related reference value  |
...
|                                   | temperature and mask scaling      |
|                                   | factors provide additional but    |
|                                   | smaller gains. Overall, the       |
|                                   | present work should be viewed as  |
|                                   | a task-oriented detection         |
