...
|                                   | possible, all YOLOv12-series      |
|                                   | ablations were conducted under    |
|                                   | the same data split, optimizer,   |
|                                   | training schedule, input          |
|                                   | resolution, and augmentation      |
|                                   | settings in this study. For       |
|                                   | external baselines, reproduced    |
|                                   | results and officially available  |
|                                   | reported results were used        |
|                                   | according to availability.        |
|                                   | Reproduced baselines were trained |
|                                   | and evaluated under the present   |
|                                   | split and evaluation protocol,    |
|                                   | whereas reported baselines were   |
|                                   | included only when the            |
|                                   | corresponding outputs could be    |
|                                   | aligned with the current metric   |
|                                   | convention. Therefore, the        |
|                                   | reproduced baselines should be    |
|                                   | regarded as strictly controlled   |
|                                   | comparisons under the present     |
|                                   | setting, while the reported       |
|                                   | baselines should be interpreted   |
|                                   | as reference comparisons rather   |
|                                   | than fully controlled             |
|                                   | reproductions. The source of each |
|                                   | baseline result is explicitly     |
|                                   | distinguished in the comparison   |
|                                   | tables.                           |
|                                   |                                   |
...
|                                   | are left blank in Tables 3 and 5. |
...
|                                   | factors provide a small           |
|                                   | additional gain under the current |
|                                   | setting, whereas the main         |
|                                   | observed contribution still       |
...
|                                   | achieves the best accuracy under  |
|                                   | the current setting with only a   |
|                                   | limited FPS reduction from 76 to  |
|                                   | 70, indicating a favorable        |
|                                   | accuracy-cost trade-off for the   |
|                                   | present evaluation pipeline.      |
|                                   |                                   |
