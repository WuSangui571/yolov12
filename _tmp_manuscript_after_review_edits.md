...
|                                   | ta_{\text{ij}})$$                 |
|                                   |                                   |
|                                   | $$S = \frac{QK^{\top}}{\sqrt{d_{h |
|                                   | }}} + B_{\text{rel}} + M_{\text{s |
|                                   | w}},$$                            |
|                                   |                                   |
|                                   | where $d_{h}$ denotes the         |
|                                   | dimension of each attention head, |
|                                   | $B_{\text{rel}}$ denotes the      |
|                                   | learnable relative position bias, |
|                                   | and $M_{\text{sw}}$ is the        |
|                                   | shifted-window mask when window   |
|                                   | shifting is enabled.. DMMA        |
|                                   | injects the difference-aware gate |
...
|                                   | head-wise learnable mask scaling  |
|                                   | factor initialized to 1.0. In the |
|                                   | current implementation, $\eta$ is |
|                                   | left unconstrained and is learned |
|                                   | jointly with the detection        |
|                                   | objective; therefore, it is       |
|                                   | interpreted as an adaptive        |
|                                   | logit-modulation gain rather than |
|                                   | a strictly non-negative           |
|                                   | suppression coefficient. The      |
|                                   | learnable temperature avoids      |
|                                   | manually fixing the strength of   |
...
|                                   | modulation of the relative        |
|                                   | pairwise affinity distribution    |
...
|                                   | intended effect is to adjust the  |
|                                   | relative dominance of             |
|                                   | structurally inconsistent         |
|                                   | interactions at the distribution  |
|                                   | level rather than to guarantee    |
|                                   | deterministic pointwise           |
|                                   | suppression for every individual  |
|                                   | logit. The multiplicative form is |
|                                   | adopted here because it preserves |
|                                   | the original attention structure  |
|                                   | with minimal implementation       |
|                                   | overhead. Additive logit-penalty  |
|                                   | formulations, such as directly    |
|                                   | subtracting a scaled difference   |
|                                   | term from the attention logits,   |
|                                   | will be further explored in       |
|                                   | future work.                      |
|                                   |                                   |
|                                   | ![](media/image2.png){width="6.31 |
|                                   | 9444444444445in"                  |
|                                   | height="4.398611111111111in"}Figu |
|                                   | re2                               |
|                                   |                                   |
|                                   | To complement the                 |
...
|                                   |                                   |
|                                   | To ensure comparability, all      |
|                                   | methods were evaluated using the  |
|                                   | same dataset splits, annotation   |
|                                   | representation, input resolution, |
|                                   | and evaluation protocol adopted   |
|                                   | in this study. YOLO-family models |
|                                   | were trained under the unified    |
|                                   | training schedule described       |
|                                   | above. For architecture-specific  |
|                                   | baselines, including DINO,        |
|                                   | LiM-YOLO, and FBVF-YOLO, the      |
|                                   | official implementations and      |
|                                   | recommended settings were         |
|                                   | followed where necessary to avoid |
|                                   | implementation mismatch.          |
|                                   | Therefore, the reported results   |
|                                   | should be interpreted as          |
|                                   | reproduced comparisons under a    |
|                                   | unified evaluation protocol,      |
|                                   | rather than as strictly           |
|                                   | parameter-matched comparisons.    |
|                                   |                                   |
|                                   | Precision and Recall for          |
|                                   | YOLO-style and RT-DETR-style      |
|                                   | models are reported from the same |
|                                   | Ultralytics validation pipeline.  |
|                                   | Since the reproduced DINO         |
|                                   | evaluation follows a COCO-style   |
|                                   | AP reporting pipeline and does    |
|                                   | not provide Precision and Recall  |
|                                   | under the identical               |
|                                   | post-processing definition, only  |
|                                   | mAP@0.5 and mAP@0.5:0.95 are      |
|                                   | reported for DINO. Therefore,     |
|                                   | cross-framework conclusions are   |
|                                   | mainly based on mAP-based         |
|                                   | metrics^\[26\]^.                  |
|                                   |                                   |
|                                   | Table2                            |
|                                   |                                   |
...
|                                   | available. Shared evaluation      |
|                                   | factors, including dataset split, |
|                                   | input resolution, annotation      |
|                                   | representation, and metric        |
|                                   | computation, were unified, while  |
|                                   | architecture-specific training    |
|                                   | details followed the official     |
|                                   | repositories where necessary to   |
|                                   | avoid implementation mismatch.    |
|                                   | Unless prevented by               |
...
|                                   | are left blank because the        |
|                                   | reproduced DINO evaluation does   |
|                                   | not provide these values under    |
|                                   | the identical post-processing     |
|                                   | definition used by the            |
|                                   | Ultralytics validation pipeline;  |
|                                   | therefore, its result is          |
|                                   | discussed only through mAP-based  |
|                                   | metrics.                          |
|                                   |                                   |
|                                   | Compared with LiM-YOLO, a recent  |
|                                   | ship-specific detector, the       |
|                                   | proposed method achieves slightly |
|                                   | higher numerical results on       |
|                                   | MASATI under the current          |
|                                   | reproduced setting. Specifically, |
|                                   | mAP@0.5 increases from 0.821 to   |
|                                   | 0.829 and mAP@0.5:0.95 increases  |
|                                   | from 0.536 to 0.545, suggesting   |
|                                   | that the proposed DMMA + ECA      |
|                                   | design remains competitive with   |
|                                   | recent ship-specific detectors    |
|                                   | under the present reproduced      |
|                                   | evaluation setting. Overall,      |
|                                   | under the present reproduced      |
|                                   | evaluation setting, the proposed  |
|                                   | model obtains the best numerical  |
|                                   | results on MASATI, although the   |
|                                   | margins over recent ship-specific |
|                                   | detectors are relatively small.   |
|                                   |                                   |
...
|                                   | provide a small additional        |
|                                   | improvement under the current     |
|                                   | setting, while the major gain     |
|                                   | still comes from the              |
|                                   | difference-aware gating mechanism |
|                                   | and the deployment of DMMA in     |
|                                   | feature-fusion stages. More       |
...
|                                   | provide small additional gains    |
...
|                                   | also indicate that DMMA           |
|                                   | deployment is position-sensitive, |
|                                   | with neck-side deployment being   |
|                                   | more effective than backbone-only |
|                                   | deployment when DMMA is used      |
|                                   | alone. The learnable temperature  |
|                                   | and mask scaling factors provide  |
|                                   | small additional improvements     |
|                                   | under the current setting, but    |
|                                   | their contribution is modest      |
|                                   | compared with the main            |
|                                   | difference-aware design. Overall, |
|                                   | the present work should be viewed |
|                                   | as a task-oriented detection      |
