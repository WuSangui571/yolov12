...
|                                   | methods whose released logs do    |
...
|                                   | more directly to                  |
|                                   | target-background discrimination, |
|                                   | while using DMMA in both backbone |
|                                   | and neck provides a more          |
|                                   | comprehensive interaction pattern |
|                                   | for the final DMMA + ECA          |
|                                   | configuration.                    |
|                                   |                                   |
|                                   | Compared with the DMMA-only       |
|                                   | model, introducing ECA and        |
|                                   | keeping the learnable temperature |
|                                   | and mask scaling factors further  |
|                                   | improves performance. The fixedτ  |
|                                   | /η variant achieves 0.835         |
|                                   | Precision, 0.728 Recall, 0.833    |
|                                   | mAP@0.5, and 0.549 mAP@0.5:0.95,  |
|                                   | which is already very close to    |
|                                   | the final model. The complete     |
|                                   | YOLOv12 + DMMA + ECA model still  |
|                                   | achieves the best overall         |
|                                   | performance, with 0.838           |
...
|                                   | further adding the ECA refinement |
|                                   | module, activations on true ship  |
|                                   | regions become more concentrated  |
|                                   | and several residual false        |
|                                   | responses are reduced, especially |
|                                   | in scenes with repetitive         |
|                                   | sea-surface textures.             |
...
|                                   | only a few pixels. These cases    |
|                                   | indicate that boundary-level      |
|                                   | localization under highly         |
|                                   | ambiguous maritime textures       |
|                                   | remains challenging, even though  |
|                                   | the updated quantitative results  |
|                                   | show that the proposed method     |
|                                   | achieves the best directly        |
|                                   | comparable results on HRSC2016-MS |
